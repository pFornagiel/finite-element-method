...
const Equation = () => {
  return ( 
    <>
      ...
      <Latex>{String.raw`$$\int_0^2 \left( -\frac{d^2 u}{dx^2} - u \right) v \, dx = \int_0^2 \sin x \, v \, dx$$`}</Latex>
      ...
      <Latex>{String.raw`$$\int_0^2 \frac{du}{dx} \frac{dv}{dx} \, dx - \left[ \frac{du}{dx} v \right]_0^2 - \int_0^2 u v \, dx = \int_0^2 \sin x \, v \, dx$$`}</Latex>
      <Latex>{String.raw`$$\int_0^2 \frac{du}{dx} \frac{dv}{dx} \, dx - \frac{du(2)}{dx} v(2) + \frac{du(0)}{dx} v(0) - \int_0^2 u v \, dx = \int_0^2 \sin x \, v \, dx$$`}</Latex>
      ...
      <Latex>{String.raw`$$\int_0^2 \frac{du}{dx} \frac{dv}{dx} \, dx - \int_0^2 u v \, dx + u(2) v(2) = \int_0^2 \sin x \, v \, dx$$`}</Latex>
      ...
      <Latex>{String.raw`$$L(v) = \int_0^2 \sin x \, v \, dx$$`}</Latex>
      <p>
